    ...
    const fetchMateriData = async () => {
      try {
        const response = await fetch(
          "http://localhost:3000/materi/details/IPS"
        );
          ...
          <div className="judulHeadline">
            <div className="headLine">
              ...
              <p className="loremLimaPuluh">
                IPS atau Ilmu Pengetahuan Sosial adalah mata pelajaran yang
                mempelajari tentang berbagai aspek kehidupan sosial, ekonomi,
                dan politik di masyarakat. Dengan memahami IPS, kita dapat lebih
                memahami dinamika masyarakat, kebijakan pemerintah, serta peran
                individu dalam pembangunan negara. Mari kita eksplorasi bersama
                dunia yang penuh warna melalui mata pelajaran IPS!
              </p>
              <Button
                className="cobaTom"
