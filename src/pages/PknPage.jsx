    ...
    const fetchMateriData = async () => {
      try {
        const response = await fetch(
          "http://localhost:3000/materi/details/PKN"
        );
          ...
          <div className="judulHeadline">
            <div className="headLine">
              ...
              <p className="loremLimaPuluh">
                Pelajari lebih dalam tentang ilmu Politik, Hukum, dan
                Kewarganegaraan (PKN). Materi ini akan membantu Anda memahami
                berbagai aspek kehidupan berbangsa dan bernegara, termasuk hak
                dan kewajiban warga negara serta sistem pemerintahan Indonesia.
                Ayo, mulai eksplorasi sekarang!
              </p>
              <Button
                className="cobaTom"
