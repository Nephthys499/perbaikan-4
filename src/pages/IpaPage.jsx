    ...
    const fetchMateriData = async () => {
      try {
        const response = await fetch(
          "http://localhost:3000/materi/details/IPA"
        );
          ...
          <div className="judulHeadline">
            <div className="headLine">
              ...
              <p className="loremLimaPuluh">
                Mari kita jelajahi keajaiban alam semesta melalui mata pelajaran
                Ilmu Pengetahuan Alam (IPA)! Dengan IPA, kita dapat memahami
                fenomena alam, memecahkan teka-teki alam semesta, dan menggali
                pengetahuan tentang kehidupan di Bumi serta di luar angkasa.
                Ayo, teman-teman, mari kita mulai petualangan kita dalam dunia
                IPA dengan penuh semangat!
              </p>
              <Button
                className="cobaTom"
