    ...
    const fetchMateriData = async () => {
      try {
        const response = await fetch(
          "http://localhost:3000/materi/details/BAHASA"
        );
          ...
          <div className="judulHeadline">
            <div className="headLine">
              ...
              <p className="loremLimaPuluh">
                Hai teman-teman, mari kita jelajahi keindahan dunia Bahasa!
                Bahasa adalah jendela dunia yang membawa kita mengeksplorasi
                kata-kata, cerita-cerita, dan keajaiban sastra. Mari kita
                belajar dengan ceria dan penuh semangat!
              </p>
              <Button
                className="cobaTom"
